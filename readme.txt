=== Webphone ===
Contributors: Webphone, webphone dynamics
Donate link: https://webphone.net
Tags: Webphone, Webphone dynamics, Webphone dinamcis, Webphone, clicktocall, c2c, calls, web, callmeback, web calls
...
Webphone is a click-to-call. The button that turns click into calls, users into clients, visits into sales. From telephone to telephone. Immediate.
...
If you found any bug in our WordPress Webphone plugin or have a question contact us at help@webphone.net or use these support channels [Support](https://dashboard.webphone.net/contact/)
...
= 2.1.8 =
*  Tested up to 6.6 WP version.

= 2.1.7 =
*  Tested up to 6.5 WP version.

= 2.1.6 =
*  Tested up to 6.4 WP version.

= 2.1.5 =
*  Tested up to 6.3 WP version.

= 2.1.4 =
*  Tested up to 6.2 WP version.

= 2.1.3 =
*  Tested up to 6.1 WP version.

= 2.1.2 =
*  Tested up to 6.0 WP version.

= 2.1.1 =
*  Tested up to 5.9 WP version.

= 2.1.0 =
*  Tested up to 5.8 WP version.

= 2.0.9 =
*  Tested up to 5.7 WP version.

= 2.0.8 =
*  Update access and registration links.

= 2.0.7 =
*  Tested up to 5.6 WP version.

= 2.0.6 =
*  Tested up to 5.5 WP version.

= 2.0.5 =
*  Tested up to 5.4 WP version.
*  Updated links.
*  Updated translations.

= 2.0.4 =
*  Updated URLs dashboard with HTTPs.
*  Updated translations
*  Tested up to 5.3.2 WP version.

= 2.0.3 =
*  Updated changelog.

= 2.0.2 =
*  Tested up to 5.3 WP version.

= 2.0.1 =
*  Minor changes: IDs widgets Webphone.

= 2.0 =
*  Last version with new functionalities (Dynamic settings).
